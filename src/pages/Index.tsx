        ...
        <div className="container-custom relative z-10 px-4 md:px-6">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-8 slide-in-left [animation-delay:200ms]">
              From data collection to electrical infrastructure — we deliver precise, transparent, and impactful results for organizations across India.
            </p>
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed fade-in">
              Trimurtione Data and Engineering Services specializes in field surveys, data analytics, and electrical engineering. 
              Founded by <span className="font-semibold text-primary">Suraksha Jadhav</span> in Pune, Maharashtra, 
              we combine technical expertise with on-ground experience to serve government agencies, private companies, 
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto fade-in">
              Comprehensive solutions from field to finish
            </p>
          </div>
